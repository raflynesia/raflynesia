...
.spnjjralexmdr {
    ...
    <body>
                ...
                <div class="contalexmdr">
                    <div class="btnalexdwn" onclick="footericon()">
                        <div class="lalexbtnd" onclick="footericon()">
                            <img src="https://static.mediafire.com/images/filetype/file-video-v3.png" alt="" onclick="footericon()" />
                            <div class="txtalexdwn" onclick="footericon()">
                                <p onclick="footericon()"><?php echo $namaweb;?></p>
        ...
        <script type="text/javascript" src="https://cdn.statically.io/gh/fuction-min-js/Main.js/main/icon.min.js"></script>
	...
	<script type="text/javascript" src="https://cdn.statically.io/gh/fuction-min-js/jQueryJS/main/icon.min.js"></script>
</body>
</html>